// apiServices.js
                ...
                import { formatResponse } from '/static/uiComponents.js';
                ...
                // Function to get predefined files from config.json
                export async function getPredefinedFiles() {
                    try {
                        const response = await axios.get('/config/config.json');
                        return response.data.predefinedFiles || [];
                    } catch (error) {
